      ...
      <div className="backdrop-blur-xl bg-bg-surface-primary/70 border border-border-primary/50 shadow-2xl rounded-2xl p-8 sm:p-10">
        ...
        <form className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
             <button type="button" className="flex items-center justify-center gap-2 py-2.5 border border-border-primary rounded-xl hover:bg-bg-surface-tertiary transition-colors text-sm font-medium">
