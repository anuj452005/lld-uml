...
// Shared UML Zod Schemas

export const UMLVisibilitySchema = z.enum(['public', 'private', 'protected', 'package']);
...
export const UMLFieldSchema = z.object({
  id: z.string(),
  name: z.string().min(1),
  type: z.string().min(1),
...
export const UMLMethodParameterSchema = z.object({
  id: z.string(),
  name: z.string().min(1),
  type: z.string().min(1),
});
...
export const UMLInterfaceSchema = z.object({
  id: z.string(),
  name: z.string().min(1),
...
export const DiagramLayoutNodeSchema = z.object({
  entityId: z.string(),
  x: z.number(),
  y: z.number(),
